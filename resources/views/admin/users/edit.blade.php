...
.pwd-toggle {
    ...
    padding: 0; font-size: .88rem; transition: color .15s;
}
...
.pwd-hint-box {
    ...
    border-radius: var(--radius-md);
    padding: 10px 14px;
    font-size: .72rem; color: var(--slate-500); line-height: 1.7;
}
...
/* Role option group */
.role-option-group { display: flex; flex-direction: column; gap: 7px; margin-bottom: 4px; }
.role-option {
...
.meta-val.mono { font-family: monospace; font-size: .7rem; }
...
.warning-box-text { font-size: .68rem; color: #78350F; line-height: 1.65; }
...
<div class="page-header">
    <div>
        ...
        <h2 class="page-header-title">Edit Pengguna</h2>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="address" class="form-control" rows="3"
                                  placeholder="Alamat lengkap pengguna...">{{ old('address', $pengguna->address) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-header-left">
                    ...
                    <span class="form-card-header-title">Ganti Password</span>
                </div>
                <span class="form-card-header-note">Kosongkan jika tidak ingin mengubah</span>
            </div>
            <div class="form-card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        <div class="pwd-hint-box">
                            <i class="bi bi-info-circle me-1" style="color:var(--blue-500);"></i>
                            Isi field ini hanya jika ingin mengganti password. Minimal <strong>8 karakter</strong>. Jika dikosongkan, password lama tetap digunakan.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="settings-card">
            ...
            <div class="settings-card-body">
                ...
                <div class="role-option-group">
                    <label class="role-option {{ old('role', $pengguna->role) === 'customer' ? 'selected' : '' }}">
                        <input type="radio" name="role" value="customer"
                               {{ old('role', $pengguna->role) === 'customer' ? 'checked' : '' }}
                    ...
                    <label class="role-option {{ old('role', $pengguna->role) === 'admin' ? 'selected' : '' }}">
                ...
                {{-- Info akun --}}
                <div class="meta-box">
                    <div class="meta-box-title">Info Akun</div>
                    <div class="meta-row">
                        <span class="meta-key">ID</span>
                        <span class="meta-val mono">#{{ $pengguna->id }}</span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-key">Bergabung</span>
                        <span class="meta-val">{{ $pengguna->created_at->format('d M Y') }}</span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-key">Total Pesanan</span>
                        <span class="meta-val">{{ $pengguna->orders()->count() }}</span>
                    </div>
                </div>

                {{-- Warning jika akun admin --}}
                @if($pengguna->isAdmin())
                <div class="warning-box">
                    <div class="warning-box-title">
                        <i class="bi bi-exclamation-triangle-fill"></i> Ini Akun Admin
                    </div>
                    <div class="warning-box-text">
                        Berhati-hatilah saat mengubah role akun admin yang sedang aktif.
                    </div>
                </div>
                @endif
                ...
                <div class="submit-wrap">
                    <button type="submit" class="btn-submit">
                        <i class="bi bi-check-lg"></i> Update Pengguna
                    </button>
                    <a href="{{ route('admin.pengguna.show', $pengguna->id) }}" class="btn-cancel">
                        Batal
                    </a>
                </div>
