...
@media (max-width: 767px) {
    ...
    .current-img-block img { width: 52px; height: 52px; }
}
</style>
@endpush
...
<div class="page-header">
    <div>
        ...
        <p class="page-header-sub">{{ Str::limit($produk->name, 50) }}</p>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control" rows="5" required
                                  placeholder="Jelaskan spesifikasi, keunggulan, dan informasi penting produk...">{{ old('description', $produk->description) }}</textarea>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-prefix-wrap">
                            ...
                            <input type="number" name="price" class="form-control"
                                   value="{{ old('price', $produk->price) }}" required min="0"
                                   placeholder="85000">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <input type="text" name="sku" class="form-control"
                               value="{{ old('sku', $produk->sku) }}" placeholder="OLI-001">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="current-img-block">
                    ...
                    <div>
                        <div class="current-img-label"><i class="bi bi-image me-1"></i>Foto Saat Ini</div>
                ...
                <div class="img-upload-area" id="uploadArea"
                    ...
                    <div class="img-upload-text" id="uploadText">
                        {{ $produk->image ? 'Klik untuk ganti foto' : 'Klik untuk pilih foto' }}
                    </div>
    ...
    <div class="col-lg-4">
        <div class="settings-card">
            ...
            <div class="settings-card-body">
                ...
                {{-- Product meta info --}}
                <div class="meta-box">
                    <div class="meta-box-title">Info Produk</div>
                    <div class="meta-row">
                        <span class="meta-key">Dibuat</span>
                        <span class="meta-val">{{ $produk->created_at->format('d M Y') }}</span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-key">Diperbarui</span>
                        <span class="meta-val">{{ $produk->updated_at->format('d M Y') }}</span>
                    </div>
                    <div class="meta-row">
                        <span class="meta-key">ID Produk</span>
                        <span class="meta-val mono">#{{ $produk->id }}</span>
                    </div>
                </div>
